...
class LRVectorBacktester(object):
    ...
    prepare_matrix:
        prepares the matrix for the regression
    fit_model:
    ...
    def fit_model(self, start, end):
        ...
        reg = np.linalg.lstsq(self.matrix[:self.lags].T,
                              np.sign(self.matrix[self.lags]))[0]
        self.reg = reg
    ...
    def run_strategy(self, start_in, end_in, start_out, end_out, lags=3):
        ...
        prediction = np.sign(np.dot(self.matrix[:self.lags].T, self.reg))
        data['prediction'] = 0.0
...
if __name__ == '__main__':
    lrbt = LRVectorBacktester('^GSPC', '2010-1-1', '2016-10-31', 10000, 0.0)
    print(lrbt.run_strategy('2010-1-1', '2016-10-31',
                            '2010-1-1', '2016-10-31'))
    print(lrbt.run_strategy('2010-1-1', '2014-12-31',
                            '2015-1-1', '2016-10-31'))
    lrbt = LRVectorBacktester('^GDAXI', '2010-1-1', '2016-10-31', 10000, 0.001)
    print(lrbt.run_strategy('2010-1-1', '2016-10-31',
                            '2010-1-1', '2016-10-31'))
    print(lrbt.run_strategy('2010-1-1', '2014-12-31',
                            '2015-1-1', '2016-10-31'))
